package com.stackroute.questions.kafka;
...
public class Sender {
	...
	private String questionGeneratorTopic = "QuestionGen";
	
	private String categoriesTopic = "Categories";

	private String randomTopic = "id";
